...
public class SecurityUtils {
    ...
    private static final Color[] COLORS = {Color.decode("#66ccff"),
            Color.decode("#ff8888"), Color.decode("#88ff88"), Color.decode("#8888ff"),
            Color.decode("#ffff88"), Color.decode("#ff88ff"), Color.decode("#88ffff"),
            Color.decode("#ffffff")};
